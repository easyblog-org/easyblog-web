...
import { j as joinRelativeURL, u as useRuntimeConfig, e as getResponseStatusText, f as getResponseStatus, h as encodePath, i as defineRenderHandler, a as getQuery, c as createError, k as getRouteRules, l as joinURL, m as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1,user-scalable=0"},{"name":"description","content":""},{"name":"referrer","content":"no-referrer"},{"name":"enable-redis-stats","content":"true"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[{"innerHTML":"(function(){try{var t=localStorage.getItem('theme');if(t==='dark'||(!t&&window.matchMedia('(prefers-color-scheme:dark)').matches)){document.documentElement.classList.add('dark')}}catch(e){}})()","tagPosition":"bodyClose"}],"noscript":[],"titleTemplate":"%s - EasyBlog","title":"EasyBlog","htmlAttrs":{"lang":"zh"}};
...
export { buildAssetsURL as a, baseURL as b, publicAssetsURL as p, renderer as r };
