<template>
  <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-5 flex items-start gap-4">
    <a
      ...
      title="访问个人主页"
    >
      <div class="w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center ring-2 ring-transparent group-hover:ring-primary/30 transition-all overflow-hidden">
    ...
    <div class="flex-1 min-w-0">
      ...
      <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">后端工程师 & AI 工程化探索者。保持好奇，耐心打磨。</p>
