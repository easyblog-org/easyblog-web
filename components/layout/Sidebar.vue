<template>
  <div class="space-y-4 lg:block">
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4">
      ...
      <div v-else class="space-y-1.5">
        <NuxtLink
          ...
          class="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary no-underline py-0.5"
        >
          <span>{{ cat.name }}</span>
          <span class="text-xs text-gray-400 dark:text-gray-600">{{ cat.count }}</span>
        </NuxtLink>
      </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4">
      <h3 class="font-semibold text-gray-900 dark:text-white mb-3 text-sm">关于作者</h3>
      <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">后端工程师，AI 探索者。保持好奇，耐心打磨。</p>
      <div class="flex items-center gap-3">
        <a href="https://github.com" target="_blank" rel="noopener" class="text-gray-400 hover:text-primary dark:text-gray-500 dark:hover:text-primary transition-colors">
        ...
        <a href="https://twitter.com" target="_blank" rel="noopener" class="text-gray-400 hover:text-primary dark:text-gray-500 dark:hover:text-primary transition-colors">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        </a>
        <a href="#" class="text-gray-400 hover:text-primary dark:text-gray-500 dark:hover:text-primary transition-colors" title="微信公众号">
