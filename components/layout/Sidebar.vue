  ...
  <div class="space-y-4 lg:block">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4">
      ...
      <div class="flex items-center gap-3">
        <a href="https://github.com/LoverITer" target="_blank" rel="noopener" class="text-gray-400 hover:text-black dark:text-gray-500 dark:hover:text-primary transition-colors">
