  ...
  <header class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md sticky top-0 z-50 border-b border-[var(--color-divider)]">
    <div class="max-w-6xl mx-auto px-4 flex items-center justify-between h-14 lg:h-16">
      ...
      <div class="flex items-center gap-3 lg:gap-4">
        ...
        <a href="https://github.com/easyblog-org/easyblog-web" target="_blank" rel="noopener" class="text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-blacktransition-colors cursor-pointer" style="min-width: 44px; min-height: 44px; display: inline-flex; align-items: center; justify-content: center;">
